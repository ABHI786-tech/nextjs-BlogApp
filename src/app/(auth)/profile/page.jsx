        ...
        <div className="min-h-screen bg-linear-to-br from-red-50 to-gray-100 flex items-center justify-center px-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="flex justify-center mb-6">
                    <div className="h-28 w-28 rounded-full bg-red-700 flex items-center justify-center text-white text-4xl font-bold shadow-lg">
                        {firstLetter}
                    </div>
                </div>
                ...
                {/* Password Section */}
                <h3 className="text-lg font-semibold mt-3 mb-1">Change Password</h3>
        ...
        <div className="mb-4">
            ...
            <div className="relative mt-1">
                ...
                <button
                    ...
                    className="absolute top-3 right-5 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                >
